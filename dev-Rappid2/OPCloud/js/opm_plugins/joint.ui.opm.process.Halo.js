...
(function(joint, _) {
    ...
    ElementHalo.prototype.add_state = function(evt, x, y) {
        ...
        //     type: 'opm.State',
        //     position: { x: x-45 , y: y+40},
        //     size: { width: 40, height: 20 },
        //     attrs: { rect: { fill: '#F1C40F' }, text: { text: 'state' } }
        //
        // });

        var r2 = new joint.shapes.opm.StateFinal();


        fatherObject.embed(r2);

        options.graph.addCells([fatherObject, r2]);
